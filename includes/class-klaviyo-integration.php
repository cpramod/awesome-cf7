 ...
 * @subpackage Klaviyo_Integration/includes
 */
...
class Klaviyo_Integration {
     ...
     *
     * - Klaviyo_Integration_Loader. Orchestrates the hooks of the plugin.
     * - Klaviyo_Integration_i18n. Defines internationalization functionality.
     * - Klaviyo_Integration_Admin. Defines all hooks for the admin area.
     * - Klaviyo_Integration_Public. Defines all hooks for the public side of the site.
     *
    ...
    private function load_dependencies() {
         ...
         * core plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-klaviyo-integration-loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-klaviyo-integration-i18n.php';

        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-klaviyo-integration-admin.php';
     ...
     *
     * Uses the Klaviyo_Integration_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    private function set_locale() {
        ...
        $plugin_i18n = new Klaviyo_Integration_i18n();
    ...
    private function define_admin_hooks() {
        ...
        $plugin_admin = new Klaviyo_Integration_Admin( $this->get_plugin_name(), $this->get_version() );
    ...
    private function define_public_hooks() {
        ...
        $plugin_public = new Klaviyo_Integration_Public( $this->get_plugin_name(), $this->get_version() );
     ...
     *
     * @since     1.0.0
     * @return    Klaviyo_Integration_Loader    Orchestrates the hooks of the plugin.
     */
